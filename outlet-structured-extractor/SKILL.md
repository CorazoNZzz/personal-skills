...
```powershell
# 1) 试跑（前 5 份）
python D:\project\skill\outlet-structured-extractor\scripts\extract_outlet_structured.py \
  --input-dir "D:\project\排口总结材料0306-含炼化(1)" \
  --output-dir "D:\project\managementsystem-main\data\outlet_structured_trial" \
  --limit 5

# 2) 全量跑
python D:\project\skill\outlet-structured-extractor\scripts\extract_outlet_structured.py \
  --input-dir "D:\project\排口总结材料0306-含炼化(1)" \
  --output-dir "D:\project\managementsystem-main\data\outlet_structured_full" \
  --all

# 3) 质检评估
python D:\project\skill\outlet-structured-extractor\scripts\assess_structured_quality.py \
  --input-dir "D:\project\managementsystem-main\data\outlet_structured_full" \
  --write-json "D:\project\managementsystem-main\data\outlet_structured_full\quality_report.json"
```
